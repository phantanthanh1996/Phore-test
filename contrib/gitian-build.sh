...
VERSION=
commit=false
url=https://github.com/phantanthanh1996/Phore-test.git
proc=2
mem=2000
lxc=true
...
then
    ...
    git clone https://github.com/phantanthanh1996/gitian.sigs.git
    git clone https://github.com/phantanthanh1996/phore-detached-sigs.git
